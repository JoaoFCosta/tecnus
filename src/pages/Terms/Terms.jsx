...
const Terms = () => {
  return (
    <>
      ...
      <p className="text-center text-header-color fs-1 fw-bold my-5">
        Política de Privacidade e Termos de Uso
      </p>

      <div className="container d-flex flex-column align-items-center justify-content-start my-5">
        <p className="text-white textLink">
        ...
        <p className="mt-2 text-white textLink">
        ...
        <ul>
          <li className="mt-2 text-white textLink">
        ...
        <p className="mt-2 text-white textLink">
          Compromisso do Usuário <br /> O usuário se compromete a fazer uso
          adequado dos conteúdos e da informação que o Tecnus Saturn oferece no
        ...
        <ul>
          ...
          <li className="mt-2 text-white textLink">
            ...
            (softwares) do Tecnus Saturn, de seus fornecedores ou terceiros,
        ...
        <p className="mt-2 text-white textLink">
          Mais informações <br /> Esperemos que esteja esclarecido e, como
          mencionado anteriormente, se houver algo que você não tem certeza se
          precisa ou não, geralmente é mais seguro deixar os cookies ativados,
          caso interaja com um dos recursos que você usa em nosso site.
        </p>

        <p className="mt-5 text-white textLink">
          <strong>Esta política é efetiva a partir de 1 May 2024 14:40</strong>
        </p>
      </div>
      <Footer />
    </>
