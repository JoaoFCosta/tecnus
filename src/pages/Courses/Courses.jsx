              ...
              <div className="row">
                <div className="col">
                  <div className="courseItem d-flex flex-column mb-3">
                    ...
                    <span className="textLink text-light ms-2 fs-3">
                      Google Drive
                    </span>
                  </div>
                </div>
                <div className="col">
                  <p className="service-description textLink text-light fs-4">
                    ...
                    compartilhamento e também colaboração de arquivos, sendo
            ...
            <div className="row">
              ...
              <div className="col">
                <p class="service-description text-start textLink text-light fs-4 mt-4">
                  O Google Docs é voltado para a produção textual de diversos
                  arquivos, como cartas, currículos, boletins informativos,
                  brochuras, relatórios, planos de aula, etc.
                </p>
              </div>
            </div>
            <div class="d-flex justify-content-between align-items-center">
              <div>
                <span class="badge rounded-2 bg-secondary mx-3 me-5 px-4 py-2 fs-5 textLink">
                  12min
                </span>
                <span class="badge rounded-2 bg-secondary px-4 ms-4 py-2 fs-5 textLink">
                  1 aula
                </span>
              </div>
              <Link to={"/google-docs"}>
            ...
            <div className="row">
              ...
              <div className="col">
                <p className="service-description textLink text-light fs-4 mt-5">
                  O gmail é um serviço que permite, ao usuário, enviar e receber
                  e-mails através do navegador, sem a necessidade de instalar um
            ...
            <div className="row">
              <div className="col">
                <div class="courseItem d-flex flex-column mb-3">
                  <div class="service-icon text-center">
                    ...
                    <span class="textLink text-light fs-3">
                      Google <br /> Planilhas
                    </span>
                  </div>
                </div>
              ...
              <div className="col">
                <p class="service-description text-start textLink text-light fs-4 mt-4">
                  ...
                  planilhas no navegador da Web sem qualquer software especial.
                  Várias pessoas podem trabalhar simultaneamente.
                </p>
              </div>
            </div>
            <div class="d-flex justify-content-between align-items-center">
              <div>
                <span class="badge rounded-2 bg-secondary mx-3 me-4 px-4 py-2 fs-5 textLink">
                  25min
                </span>
                <span class="badge rounded-2 bg-secondary px-4 ms-4 py-2 fs-5 textLink">
                  3 aulas
            ...
            <div className="row">
              <div className="col">
                <div className="courseItem d-flex flex-column mb-3">
                  <img
                    src={Apresentacao}
                    alt="Google Apresentação"
                    width="200"
                  />
                  <span className="textLink text-light ms-2 fs-3 text-center">
                    Google <br /> apresentações
                  </span>
                </div>
              </div>
              <div className="col">
                <p className="service-description textLink text-light fs-4 mt-2">
                  O google apresentações permite criar e formatar slides em
                  nuvem, onde todas as mudanças que você fizer serão salvas.
                  Você pode editar um modelo pronto ou criar um novo.
                </p>
              </div>
            </div>
            <div className="d-flex justify-content-between align-items-center">
        ...
        <div class="col-md-5">
          <div class="card-body">
            <div className="row">
              ...
              <div className="col">
                <p class="service-description text-start textLink text-light fs-4 mt-4">
                  O google classroom é uma ferramenta on-line gratuita que
                  auxilia professores, alunos e escolas com um espaço para a
                  realização de aulas virtuais de maneira organizada.
                </p>
              </div>
            </div>
            <div class="d-flex justify-content-between align-items-center">
        ...
        <div className="col-md-5">
          <div className="card-body">
            <div className="row">
              ...
              <div className="col">
                <p className="service-description textLink text-light fs-4 mt-2">
                  A sua segurança é algo essencial no meio tecnológico, para
                  manter suas informações pessoais em sigilo.
                </p>
              </div>
            </div>
            <div className="d-flex justify-content-between align-items-center">
        ...
        <div class="col-md-5">
          <div class="card-body">
            <div className="row">
              ...
              <div className="col">
                <p class="service-description text-start textLink text-light fs-4 mt-4">
                  O Excel é um software de planilhas eletrônicas, que utiliza
                  tabelas para realizar cálculos ou apresentar dados. Com ele, é
                  possível organizar orçamentos, por exemplo.
                </p>
              </div>
            </div>
            <div class="d-flex justify-content-between align-items-center">
